...
func buildDoctorChecks(cityPath string, cfg *config.City, cfgErr error, opts buildDoctorChecksOpts) []doctor.Check {
	...
	if cfgErr == nil && cfg != nil {
		...
		register(doctor.NewSlingTargetsOverrideCheck(cfg))
		...
		register(newMCPRejectedServersDoctorCheck(cityPath, cfg, exec.LookPath))
	}
	...
	if cfgErr == nil && cfg != nil {
		...
		register(newRoutedWorkWorkableCheck(cfg, cityPath, storeFactory))
	}

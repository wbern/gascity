...
func TestComputePoolDesiredStates_TraceListsActiveCapacityBlockers(t *testing.T) {
	...
	result := computePoolDesiredStates(cfg, work, nil, sessionInfosFromBeads(sessions), map[string]int{"claude": 1}, nil, 0, poolNewDemandLoadVeto{}, nil, trace)
...
func TestComputePoolDesiredStates_TraceBlamesActualBindingCapNotOwnCeiling(t *testing.T) {
	...
	result := computePoolDesiredStates(cfg, nil, nil, nil, map[string]int{"claude": 8}, nil, 0, poolNewDemandLoadVeto{}, nil, trace)
...
func TestComputePoolDesiredStates_CapsNewDemandBeforeMaterializingRequests(t *testing.T) {
	...
	result := computePoolDesiredStates(cfg, work, nil, sessionInfosFromBeads(sessions), map[string]int{"claude": 10}, nil, 0, poolNewDemandLoadVeto{}, nil, trace)
...
func TestComputePoolDesiredStates_InFlightDemandRecordsTrace(t *testing.T) {
	...
	result := computePoolDesiredStates(cfg, nil, nil, sessionInfosFromBeads(sessions), map[string]int{"claude": 5}, nil, 0, poolNewDemandLoadVeto{}, nil, trace)
...
func TestComputePoolDesiredStates_PairedCallsAgreeOnSameSeed(t *testing.T) {
	...
	splitAtSeed := func(seed uint64) map[string]int {
		buildPlan := PoolDesiredCounts(ComputePoolDesiredStatesWithDemandTracedWithSeed(cfg, nil, nil, nil, scaleCheck, nil, seed, poolNewDemandLoadVeto{}, nil, nil))
		wakePlan := PoolDesiredCounts(ComputePoolDesiredStatesTracedWithSeed(cfg, nil, nil, scaleCheck, seed, poolNewDemandLoadVeto{}, nil, nil))
...
func TestComputePoolDesiredStates_ZeroDemandRecordsSkipDecision(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result := computePoolDesiredStates(cfg, nil, nil, sessions, tt.scaleCheckCounts, nil, 0, poolNewDemandLoadVeto{}, nil, trace)

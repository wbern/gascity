...
func deepCopyAgent(src *config.Agent, name, dir string) config.Agent {
	dst := config.Agent{
		...
		ClaimHolderStallTimeout: src.ClaimHolderStallTimeout,
	...
	dst.SkillInclude = append([]string(nil), src.SkillInclude...)
	dst.SkillExclude = append([]string(nil), src.SkillExclude...)

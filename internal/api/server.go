...
type Server struct {
	...
	// storeHealthRefreshing, storeHealthLastErr and storeHealthRetryAfter
	// keep a cold or expired measurement off the request path: statusStoreHealth
	// reports what it already has and refreshes in the background.

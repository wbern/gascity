 ...
 */
export const getV0CityByCityNameBeadsEphemeral = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNameBeadsEphemeralData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNameBeadsEphemeralResponses, GetV0CityByCityNameBeadsEphemeralErrors, ThrowOnError>({ url: '/v0/city/{cityName}/beads/ephemeral', ...options });
...
/**
 * Get v0 city by city name beads ready summary
 */
export const getV0CityByCityNameBeadsReadySummary = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNameBeadsReadySummaryData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNameBeadsReadySummaryResponses, GetV0CityByCityNameBeadsReadySummaryErrors, ThrowOnError>({ url: '/v0/city/{cityName}/beads/ready/summary', ...options });

...
// to derive the repository from the source it already holds.
...
// Measured before this binding existed: interleaving two binaries over one
// cache turned a 255 ms command into 340 ms and produced intermittent
// non-zero exits.
//

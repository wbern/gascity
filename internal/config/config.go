...
type SessionConfig struct {
	...
	// every other liveness surface (upstream gastownhall/gascity#4012). Because
	// recycling a claim-holder discards in-progress work, set this above the
	// longest legitimate quiet period a working claim-holder can exhibit — well
	// above ProgressStallTimeout. Values below 5m are clamped to 5m. Duration
	// string (e.g. "20m"). Unset/zero disables it.
